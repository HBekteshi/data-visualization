...
def create_radial_coordinates(width, height, node_list):
    ...
    for child in direct_root_children:
        ...
        calc_radial_coordinates_children(children_of_child, child_id, annulus_wedge_angles, coordinates, start_radius, distance_between_layers)
