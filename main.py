...
for e in G.edges():
    ...
    if weighted:
        weight = G[u][v]["weight"]
        adjacency_dict[u].append(
            (v, True, weight))  # True = will be rendered graphically; False = has already been rendered graphically
        adjacency_dict[v].append((u, False, weight))  # for directed graph, make sure direction is u-->v for True

    else:
        adjacency_dict[u].append(
            (v, True, 1))  # True = will be rendered graphically; False = has already been rendered graphically
...
def create_solar_coordinates(width, height, adjacency_dict, deterministic=False):
    ...
    nr_rings = len(
        set(adjacencies.values()))  # calculate # of rings based on the # of unique values in adjacency numbers
...
def assign_to_rings(adjacencies):
    ...
    rings_dict = {}
    for ring in set(
            adjacencies.values()):  # create a ring for each unique value in the adjacencies, with that key value as the key
        rings_dict[ring] = []
...
def create_radial_coordinates(width, height, node_list):
    ...
    distance_between_layers = 80  # play with this number, this is for the distance between the C layers, later make it into width/height function
    start_radius = 80  # initialize the radius of the first layer, still make this into width/height function
    ...
    print("root childrenn", direct_root_children)
...
def calc_ann_wedge(node_list, parent_id, child_id, radius1, radius2):
    ...
    length_angle = 2 * math.acos(
        length_child / (length_parent))  # not -1 as in the slides because the parent itself is not in the list
...
node_list_dfs = [('11', '11'), ('11', '2'), ('2', '1'), ('2', '3'), ('3', '4'), ('2', '5'), ('2', '6'), ('2', '7'),
                 ('2', '8'), ('2', '9'),
                 ('2', '10'), ('11', '12'), ('11', '13'), ('13', '24'), ('24', '17'), ('17', '18'), ('18', '27'),
                 ('27', '25'), ('25', '26'),
                 ('26', '28'), ('28', '29'), ('29', '45'), ('29', '46'), ('28', '30'), ('30', '35'), ('35', '36'),
                 ('36', '37')]
